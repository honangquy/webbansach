...
<div class="container py-4">
    ...
    };"<?php echo e(route('cart.index')); ?>">Giỏ hàng</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center py-2 border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <?php endif; ?>
                                <div>
                                    <h6 class="mb-0 small"><?php echo e(Str::limit($item['book']->title, 30)); ?></h6>
                                    <small class="text-muted"><?php echo e($item['book']->author); ?></small>
                                    <br>
                                    <small class="text-primary">Số lượng: <?php echo e($item['quantity']); ?></small>
                                </div>
                            </div>
                            <span class="fw-bold text-danger"><?php echo e(number_format($item['subtotal'])); ?>đ</span>
                        </div>
                        ...
                        <?php if(isset($coupon) && $discountAmount > 0): ?>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-success">
                                <i class="fas fa-tag"></i> Mã giảm giá (<?php echo e($coupon['code']); ?>):
                            </span>
                            <span class="text-success">-<?php echo e(number_format($discountAmount)); ?>đ</span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <strong class="text-danger fs-5"><?php echo e(number_format($finalTotal ?? $total)); ?>đ</strong>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div id="qr_code_section" class="mt-3" style="display: none;">
                            ...
                            <div class="text-center">
                                ...
                                <div class="mt-3">
                                    <div class="qr-amount">
                                        Số tiền: <span id="qr_amount"><?php echo e(number_format($finalTotal ?? $total)); ?>đ</span>
                                    </div>
                                    <div class="mt-2">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <a href="<?php echo e(route('profile.edit')); ?>" class="alert-link" target="_blank">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="customer_name" 
                                       name="customer_name" value="<?php echo e($user->name); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" id="customer_email" 
                                       name="customer_email" value="<?php echo e($user->email); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="customer_phone" 
                                   name="customer_phone" value="<?php echo e($user->phone ?? ''); ?>" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="shipping_address" name="shipping_address" 
                                      rows="3" placeholder="Số nhà, tên đường, phường/xã, quận/huyện, tỉnh/thành phố" required><?php echo e($user->address ?? ''); ?></textarea>
                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-outline-secondary me-md-2">
...
$('#loadProfileInfo').on('click', function() {
    ...
    $('#customer_phone').val('<?php echo e($user->phone ?? ""); ?>');
    $('#shipping_address').val('<?php echo e($user->address ?? ""); ?>');
...
$('input[name="payment_method"]').on('change', function() {
    ...
    if (selectedMethod === 'qr_code') {
        ...
        const totalAmount = <?php echo e($finalTotal ?? $total); ?>;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/frontend/orders/checkout.blade.php ENDPATH**/ ?>