<?php if($activeFlashSale && $activeFlashSale->items->count() > 0): ?>
<section class="flash-sale-section py-4">
    <div class="container position-relative">
        ...
        <div class="flash-sale-header d-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo e(route('books.index')); ?>" class="btn-see-all">
                Xem tất cả
        ...
        <div class="flash-sale-carousel-wrapper">
            ...
            <div class="flash-sale-carousel" id="flashSaleCarousel">
                <?php $__currentLoopData = $activeFlashSale->items->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($item->book && $item->hasStock()): ?>
                        <div class="flash-sale-item">
                            <a href="<?php echo e(route('books.show', $item->book->id)); ?>" class="flash-sale-card">
                                <!-- Image -->
                                <div class="flash-sale-image">
                                    <?php if($item->book->image): ?>
                                        <img src="<?php echo e($item->book->image_url); ?>" alt="<?php echo e($item->book->title); ?>">
                                    <?php else: ?>
                                        <div class="no-image">
                                    ...
                                    <!-- Badge -->
                                    <span class="flash-badge">Tập <?php echo e($loop->iteration); ?></span>
                                </div>
                                
                                <!-- Title -->
                                <h6 class="flash-sale-book-title"><?php echo e(Str::limit($item->book->title, 45)); ?></h6>
                                
                                <!-- Price -->
                                <div class="flash-sale-price">
                                    <span class="price-flash"><?php echo e(number_format($item->flash_price)); ?> đ</span>
                                    <span class="price-discount">-<?php echo e($item->discount_percent); ?>%</span>
                                </div>
                                <div class="price-original"><?php echo e(number_format($item->book->price)); ?>đ</div>
                                ...
                                <div class="flash-sale-progress">
                                    ...
                                    ?>
                                    <div class="progress">
                                        <div class="progress-bar" style="width: <?php echo e($soldPercent); ?>%"></div>
                                    </div>
                                    <span class="progress-label">Đã bán <?php echo e($item->sold_quantity); ?></span>
                                </div>
                            </a>
                        </div>
                    <?php endif; ?>
...
<script>
// Countdown timer
const endTime = new Date("<?php echo e($activeFlashSale->end_time->format('Y-m-d H:i:s')); ?>").getTime();
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/frontend/partials/flash-sale.blade.php ENDPATH**/ ?>