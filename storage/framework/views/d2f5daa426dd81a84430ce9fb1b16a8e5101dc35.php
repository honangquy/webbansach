...
function updateOrderStatus() {
    ...
    const url = 'http://localhost/webbansach/laravel-app/public/admin/orders/<?php echo e($order->id); ?>/update-status';
    console.log('URL:', url);
...
function cancelOrder() {
    ...
    $.post('http://localhost/webbansach/laravel-app/public/admin/orders/<?php echo e($order->id); ?>/update-status', {
        status: 'cancelled',
