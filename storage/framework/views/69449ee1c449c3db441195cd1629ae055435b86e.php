<?php if($paginator->hasPages()): ?>
    <style>
        /* Ensure pagination SVG icons remain at a readable size */
        .pagination-icon { width: 1em !important; height: 1em !important; font-size: 1em !important; vertical-align: middle; display: inline-block; }
    </style>
                    ...
                    <?php if($paginator->onFirstPage()): ?>
                        <span aria-disabled="true" aria-label="<?php echo e(__('pagination.previous')); ?>">
                            <span class="relative inline-flex items-center px-2 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default rounded-l-md leading-5" aria-hidden="true">
                                <svg class="w-5 h-5 pagination-icon" fill="currentColor" viewBox="0 0 20 20">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>