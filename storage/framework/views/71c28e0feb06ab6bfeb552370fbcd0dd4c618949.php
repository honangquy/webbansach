...
<div class="container py-4">
            ...
            <ul class="nav nav-pills justify-content-center" id="orderTabs">
                <li class="nav-item">
                    <a class="nav-link active" data-status="all" href="#all">
                        ...
                        <span class="badge bg-secondary ms-1"><?php echo e($totalOrders ?? $orders->total()); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-status="pending" href="#pending">
                        <i class="fas fa-clock"></i> Chờ xử lý
                        <span class="badge bg-warning ms-1"><?php echo e($orderCounts['pending'] ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-status="processing" href="#processing">
                        <i class="fas fa-cog"></i> Đang xử lý
                        <span class="badge bg-info ms-1"><?php echo e($orderCounts['processing'] ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-status="shipped" href="#shipped">
                        <i class="fas fa-truck"></i> Đang giao
                        <span class="badge bg-primary ms-1"><?php echo e($orderCounts['shipped'] ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-status="delivered" href="#delivered">
                        <i class="fas fa-check-circle"></i> Đã giao
                        <span class="badge bg-success ms-1"><?php echo e($orderCounts['delivered'] ?? 0); ?></span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-status="cancelled" href="#cancelled">
                        <i class="fas fa-times-circle"></i> Đã hủy
                        <span class="badge bg-danger ms-1"><?php echo e($orderCounts['cancelled'] ?? 0); ?></span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <?php if($orders->count() > 0): ?>
        <div id="ordersList">
            ...
            <div class="card mb-3 order-item" data-status="<?php echo e($order->status); ?>">
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-0 small"><?php echo e(Str::limit($detail->book->title, 25)); ?></h6>
                                            <small class="text-muted">x<?php echo e($detail->quantity); ?></small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 mb-2">
                                    <div class="d-flex align-items-center justify-content-center h-100">
                                        <span class="text-muted">
                                            ...
                                            <?php echo e($order->orderDetails->count() - 3); ?> sản phẩm khác
                                        </span>
                                    </div>
                                </div>
                                <?php endif; ?>
                        ...
                        <div class="col-lg-4">
                            <div class="text-lg-end">
                                <div class="mb-2">
                                    ...
                                    <br>
                                                                    <div class="text-end">
                                    <span class="h5 text-danger mb-0"><?php echo e(number_format($order->final_amount ?? $order->total_amount)); ?>đ</span>
                                </div>
                                <div class="mb-2">
                                    <small class="text-muted"><?php echo e($order->orderDetails->count()); ?> sản phẩm</small>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <?php if(in_array($order->status, ['pending', 'processing'])): ?>
                                <button class="btn btn-outline-danger btn-sm me-2" onclick="cancelOrder(<?php echo e($order->id); ?>)">
                        ...
                        <div>
                            ...
                            <?php if(in_array($order->status, ['pending', 'processing'])): ?>
                                <button class="btn btn-primary btn-sm ms-2" onclick="trackOrder(<?php echo e($order->id); ?>)">
                                    <i class="fas fa-map-marker-alt"></i> Theo dõi
                                </button>
                            <?php endif; ?>
                            
                            <?php if($order->status == 'delivered'): ?>
                                <button class="btn btn-success btn-sm ms-2" onclick="reorder(<?php echo e($order->id); ?>)">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/frontend/orders/index.blade.php ENDPATH**/ ?>