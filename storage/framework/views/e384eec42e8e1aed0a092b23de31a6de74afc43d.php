...
<?php $__env->startSection('page-title', 'Chỉnh sửa Flash Sale'); ?>
...
<form action="<?php echo e(route('admin.flash-sales.update', $flashSale->id)); ?>" method="POST" id="flashSaleForm">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="title" 
                           name="title" 
                           value="<?php echo e(old('title', $flashSale->title)); ?>" 
                           required>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            name="status" 
                            required>
                        <option value="1" <?php echo e(old('status', $flashSale->status) == '1' ? 'selected' : ''); ?>>Bật</option>
                        <option value="0" <?php echo e(old('status', $flashSale->status) == '0' ? 'selected' : ''); ?>>Tắt</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>" 
                          id="description" 
                          name="description" 
                          rows="3"><?php echo e(old('description', $flashSale->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                           id="start_time" 
                           name="start_time" 
                           value="<?php echo e(old('start_time', $flashSale->start_time->format('Y-m-d\TH:i'))); ?>" 
                           required>
...
unset($__errorArgs, $__bag); ?>" 
                           id="end_time" 
                           name="end_time" 
                           value="<?php echo e(old('end_time', $flashSale->end_time->format('Y-m-d\TH:i'))); ?>" 
                           required>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <div id="booksContainer">
                <?php $__currentLoopData = $flashSale->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="book-item card mb-3">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <label class="form-label">Sách <span class="text-danger">*</span></label>
                                    <select class="form-select book-select" name="books[<?php echo e($index); ?>][book_id]" required>
                                        <option value="">-- Chọn sách --</option>
                                        <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($book->id); ?>" 
                                                    data-price="<?php echo e($book->price); ?>"
                                                    <?php echo e($item->book_id == $book->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           name="books[<?php echo e($index); ?>][flash_price]" 
                                           value="<?php echo e($item->flash_price); ?>"
                                           data-original-price="<?php echo e($item->book->price); ?>"
                                           min="0" 
                                           step="0.01" 
                                           required>
                                    <small class="text-success discount-percent">Giảm <?php echo e($item->discount_percent); ?>%</small>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Số lượng <span class="text-danger">*</span></label>
                                    <input type="number" 
                                           class="form-control" 
                                           name="books[<?php echo e($index); ?>][stock_quantity]" 
                                           value="<?php echo e($item->stock_quantity); ?>"
                                           min="1" 
                                           required>
                                    <small class="text-muted">Đã bán: <?php echo e($item->sold_quantity); ?></small>
                                </div>
                                <div class="col-md-2">
...
document.addEventListener('DOMContentLoaded', function() {
    let bookIndex = <?php echo e($flashSale->items->count()); ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/admin/flash-sales/edit.blade.php ENDPATH**/ ?>