...
<div class="row mb-4">
    <div class="col-md-3">
        <a href="<?php echo e(route('admin.statistics.sales')); ?>" class="card text-decoration-none">
    ...
    <div class="col-md-3">
        <a href="<?php echo e(route('admin.statistics.customers')); ?>" class="card text-decoration-none">
            <div class="card-body text-center">
    ...
    <div class="col-md-3">
        <a href="<?php echo e(route('admin.statistics.products')); ?>" class="card text-decoration-none">
            <div class="card-body text-center">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h5>Cảnh báo</h5>
                <p class="text-muted mb-2"><?php echo e($stats['pending_orders']); ?> đơn chờ xử lý</p>
                <p class="text-muted"><?php echo e($stats['low_stock_books']); ?> sách sắp hết</p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('admin.statistics.sales')); ?>">Xem chi tiết</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                        <i class="fas fa-circle 
                            <?php if($status == 'pending'): ?> text-warning
                            <?php elseif($status == 'processing'): ?> text-info  
                            <?php elseif($status == 'shipped'): ?> text-primary
                            <?php elseif($status == 'delivered'): ?> text-success
                            <?php elseif($status == 'cancelled'): ?> text-danger
                            <?php endif; ?>"></i>
                        ...
                        <tbody>
                            <?php if($topBooks->count() > 0): ?>
                                ...
                                <tr>
                                    <td>
                                        <?php if($book->book): ?>
                                            <strong><?php echo e(Str::limit($book->book->title, 30)); ?></strong><br>
                                            <small class="text-muted"><?php echo e($book->book->author); ?></small>
                                        <?php else: ?>
                                            <em class="text-muted">Sách không tồn tại</em>
                                        <?php endif; ?>
                                    </td>
                                    <td><?php echo e($book->total_sold); ?></td>
                                    <td>
                                        <?php if($book->book): ?>
                                            <?php echo e(number_format($book->book->price * $book->total_sold)); ?>đ
                                        <?php else: ?>
                                            0đ
                                        <?php endif; ?>
                                    </td>
...
async function initializeCharts() {
    try {
        ...
        const ordersByStatus = <?php echo json_encode($ordersByStatus); ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (periodSelect) {
        periodSelect.addEventListener('change', function() {
            window.location.href = '<?php echo e(route("admin.statistics.index")); ?>?period=' + this.value;
        });
    }
});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/admin/statistics/index.blade.php ENDPATH**/ ?>