...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Chi tiết đơn hàng #<?php echo e($order->order_number); ?></li>
        </ol>
    </nav>
    ...
    <div class="row mb-4">
        <div class="col-lg-8">
            <h1 class="h3 mb-2">
                ...
                Đơn hàng #<?php echo e($order->order_number); ?>

            </h1>
            <p class="text-muted mb-0">
                Đặt ngày <?php echo e($order->created_at->format('d/m/Y')); ?> lúc <?php echo e($order->created_at->format('H:i')); ?>
                                ...
                                <tr>
                                    <td class="py-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="mb-1">
                                                    <a href="<?php echo e(route('books.show', $detail->book)); ?>" 
                                                       class="text-decoration-none">
                                                        <?php echo e($detail->book->title); ?>

                                                    </a>
                                                </h6>
                                                <p class="text-muted mb-1 small"><?php echo e($detail->book->author); ?></p>
                                                <p class="text-muted mb-0 small">
                                                    <i class="fas fa-tag"></i> <?php echo e($detail->book->category->name); ?>
                                    ...
                                    <td class="py-3 text-center align-middle">
                                        <span class="badge bg-secondary fs-6"><?php echo e($detail->quantity); ?></span>
                                    </td>
                                    <td class="py-3 text-end align-middle">
                                        <?php echo e(number_format($detail->price)); ?>đ
                                    </td>
                                    <td class="py-3 text-end align-middle">
                                        <strong class="text-danger"><?php echo e(number_format($detail->total)); ?>đ</strong>
                                    </td>
                                </tr>
                        ...
                        <?php $__currentLoopData = $order->orderDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="mb-3 border-bottom pb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <div class="me-3">
                                        <img src="<?php echo e($detail->book->image_url); ?>" alt="" style="width:60px;height:60px;object-fit:cover;border-radius:4px;">
                                    </div>
                                    <div>
                                        <h6 class="mb-1"><?php echo e($detail->book->title); ?></h6>
                                        <small class="text-muted">Số lượng: <?php echo e($detail->quantity); ?></small>
                                    </div>
                                </div>
                                ...
                                <?php else: ?>
                                    <form method="POST" action="<?php echo e(route('orders.reviews.store', $order)); ?>">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="order_id" value="<?php echo e($order->id); ?>">
                                        <input type="hidden" name="book_id" value="<?php echo e($detail->book->id); ?>">

                                        <div class="mb-2">
                                            <label class="form-label fw-bold">Đánh giá:</label>
                                            <div class="star-select" data-target-input="rating-<?php echo e($detail->book->id); ?>">
                                                <?php for($i=1;$i<=5;$i++): ?>
                                                    <i class="far fa-star fa-2x star" data-value="<?php echo e($i); ?>" style="cursor:pointer;color:#ccc;margin-right:6px;"></i>
                                                <?php endfor; ?>
                                            </div>
                                            <input type="hidden" id="rating-<?php echo e($detail->book->id); ?>" name="rating" value="5">
                                        </div>
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <a href="<?php echo e(route('books.show', $detail->book->id)); ?>" class="btn btn-outline-secondary">Xem sản phẩm</a>
                                        </div>
                                    </form>
                                <?php endif; ?>
                            </div>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-6 text-end">#<?php echo e($order->order_number); ?></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-6"><strong>Ngày đặt:</strong></div>
                        <div class="col-6 text-end"><?php echo e($order->created_at->format('d/m/Y')); ?></div>
                    </div>
                    <div class="row mb-2">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="mailto:<?php echo e($order->customer_email); ?>" class="text-decoration-none">
                    ...
                    <div class="mb-3">
                        ...
                        <a href="tel:<?php echo e($order->customer_phone); ?>" class="text-decoration-none">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2">
                        <span>Tạm tính:</span>
                        <span><?php echo e(number_format($order->total_amount)); ?>đ</span>
                    </div>
                    <?php if($order->discount_amount > 0): ?>
                    <div class="d-flex justify-content-between mb-2">
                        <span>Giảm giá:</span>
                        <span class="text-success">-<?php echo e(number_format($order->discount_amount)); ?>đ</span>
                    </div>
                    <?php endif; ?>
                    <div class="d-flex justify-content-between mb-2">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <strong class="text-danger fs-5"><?php echo e(number_format($order->final_amount ?? $order->total_amount)); ?>đ</strong>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Bạn có chắc chắn muốn hủy đơn hàng <strong>#<?php echo e($order->order_number); ?></strong> không?</p>
                <div class="mb-3">
...
$('#confirmCancel').on('click', function() {
    ...
    $.ajax({
        url: `/orders/<?php echo e($order->id); ?>/cancel`,
        method: 'POST',
        data: { reason: reason },
...
function reorder() {
    $.ajax({
        url: `/orders/<?php echo e($order->id); ?>/reorder`,
        method: 'POST',
        success: function(response) {
            if (response.success) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webbansach\laravel-app\resources\views/frontend/orders/show.blade.php ENDPATH**/ ?>