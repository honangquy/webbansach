                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        ...
                                        <?php if($customer->role !== 'admin'): ?>
                                            <?php if($customer->role === 'staff'): ?>
                                                <form action="<?php echo e(route('admin.customers.demote', $customer)); ?>" method="POST" class="d-inline ms-2">
                                                    <?php echo csrf_field(); ?>
                                            ...
                                            <?php else: ?>
                                                <form action="<?php echo e(route('admin.customers.promote', $customer)); ?>" method="POST" class="d-inline ms-2">
                                                    <?php echo csrf_field(); ?>
