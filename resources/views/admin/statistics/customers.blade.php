            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($customerStats['active_customers']) }}</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($customerStats['new_customers_this_month']) }}</div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($customerStats['customers_with_orders']) }}</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong class="text-success">
                                        {{ number_format($customer->orders->first()->total_spent ?? 0) }}đ
                                    </strong>
                                </td>
...
const registrationChart = new Chart(registrationCtx, {
    type: 'line',
    data: {
        labels: {!! json_encode($customerRegistrations->map(function($item) { return $item->month . '/' . $item->year; })) !!},
        datasets: [{
            label: 'Số khách hàng đăng ký',
            data: {!! json_encode($customerRegistrations->pluck('count')) !!},
