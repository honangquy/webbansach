            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" 
                            ...
                            name="status" 
                            required>
                        <option value="1" {{ old('status', $flashSale->status) == '1' ? 'selected' : '' }}>Bật</option>
                        <option value="0" {{ old('status', $flashSale->status) == '0' ? 'selected' : '' }}>Tắt</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           data-original-price="{{ $item->book->price }}"
                                           min="0" 
                                           step="0.01" 
                                           required>
                                    <small class="text-success discount-percent">Giảm {{ $item->discount_percent }}%</small>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="1" 
                                           required>
                                    <small class="text-muted">Đã bán: {{ $item->sold_quantity }}</small>
                                </div>
                                <div class="col-md-2">
...
document.addEventListener('DOMContentLoaded', function() {
    let bookIndex = {{ $flashSale->items->count() }};
