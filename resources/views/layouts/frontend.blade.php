    ...
    <nav class="modern-nav">
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="{{ route('books.index') }}" class="{{ request()->routeIs('books.*') ? 'active' : '' }}">Sách</a></li>
            ...
            <!-- Search Form (Desktop) -->
            <form class="nav-search" method="GET" action="{{ route('books.index') }}">
                <input type="search" name="search" placeholder="Tìm kiếm sách..." value="{{ request('search') }}">
                <button type="submit">
            ...
            <div class="nav-actions">
                @guest
                    <a href="{{ route('login') }}" class="auth-btn login">Đăng nhập</a>
            ...
            <div class="mobile-menu" id="mobileMenu">
                <form class="mobile-search" method="GET" action="{{ route('books.index') }}">
                    <input type="search" name="search" placeholder="Tìm kiếm sách..." value="{{ request('search') }}">
                    <button type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
