...
<style>
    ...
    .auth-bg {
        ...
        width: 100%;
        height: 100%;
        /* Add color gradient overlay to boost vibrancy */
    ...
    .auth-overlay {
        position: fixed;
        inset: 0;
        /* lighten the overlay so the colorful base comes through */
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="auth-card">
                ...
                <div class="auth-sub">Tạo tài khoản mới để quản lý đơn hàng và thanh toán nhanh hơn</div>
