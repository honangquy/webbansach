            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <label class="remember"><input type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }}> Ghi nhớ đăng nhập</label>
                    ...
                    <div class="text-center mt-3 small">Chưa có tài khoản? <a href="{{ route('register') }}">Tạo tài khoản</a></div>
                </form>
            </div>
        </div>
    </div>
